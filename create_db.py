...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'joescope', 'email': 'joescope@terpmail.umd.edu', 'first_name':'Joe', 'last_name':'Scopelliti',
            'password': generate_password_hash('joescope', method='sha256'), 'role':'STUDENT'}
    ]
